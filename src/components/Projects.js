...
let projects = [{front:"https://github.com/Jasonnnz/jobra_frontend", back:"https://github.com/Jasonnnz/jobra_backend", image:jobra, name: "Jobra", description: "A React application inspired by “Trello”, that allows users to keep track of job applications with a data layer to allow the creation of ad hoc charts.", languages: "React, Ruby on Rails, PostgreSQL, ChartJS"},
                ...
                {front:"https://github.com/Jasonnnz/steam0.5_frontend", back:"https://github.com/Jasonnnz/steam0.5_backend", image:steam, name: "Steam0.5", description: "A single-page application inspired by the existing games application, 'Steam', that allows a user to connect and find common game interests with other users.", languages: "JavaScript, Ruby on Rails, PostgreSQL, HTML, CSS"},]
...
function Projects(){
    let projs = projects.map((p) => {
        return <Card style={{height:"55%", width:"23%"}} 
        image={p.image} 
        header={p.name} 
